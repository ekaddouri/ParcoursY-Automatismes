...
<li>1 m³ = 1 000 000 cm³ = 1000 L</li>
  ...
  exercises:[
{n:1,title:"Simplifier des fractions",
...
{n:2,title:"Opérations sur les fractions",
...
{n:3,title:"Pourcentages et évolutions",
statement:`<ol>
...
{n:4,title:"Puissances de 10 et notation scientifique",
...
{n:5,title:"Conversions d'unités",
...
{n:6,title:"Proportionnalité et échelles",
...
{n:7,title:"Calculs avec les racines carrées",
...
svg:`<div class="graph-container"><svg viewBox="0 0 500 350" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="120" y="30" fill="#e8eaf0" font-size="15" font-family="Inter,sans-serif" font-weight="bold">Dosage beton 1:2:3 -- 900 kg</text>
  <rect x="50" y="100" width="50" height="60" fill="#8b8fa3" rx="3"/>
  <rect x="100" y="100" width="100" height="60" fill="#f59e0b" rx="3"/>
  <rect x="200" y="100" width="150" height="60" fill="#f97316" rx="3"/>
  <text x="55" y="136" fill="#1a1d27" font-size="12" font-family="Inter,sans-serif" font-weight="bold">Ciment</text>
  <text x="60" y="150" fill="#1a1d27" font-size="10" font-family="Inter,sans-serif">150 kg</text>
  <text x="115" y="136" fill="#1a1d27" font-size="12" font-family="Inter,sans-serif" font-weight="bold">Sable</text>
  <text x="120" y="150" fill="#1a1d27" font-size="10" font-family="Inter,sans-serif">300 kg</text>
  <text x="215" y="136" fill="#e8eaf0" font-size="12" font-family="Inter,sans-serif" font-weight="bold">Gravier</text>
  <text x="220" y="150" fill="#e8eaf0" font-size="10" font-family="Inter,sans-serif">450 kg</text>
  <text x="170" y="210" fill="#e8eaf0" font-size="16" font-family="Inter,sans-serif" font-weight="bold">1 : 2 : 3</text>
  <text x="130" y="240" fill="#8b8fa3" font-size="11" font-family="Inter,sans-serif">(ciment : sable : gravier)</text>
  <rect x="50" y="270" width="300" height="8" fill="none" stroke="#8b8fa3" stroke-width="1" rx="2"/>
  <line x1="50" y1="278" x2="350" y2="278" stroke="#8b8fa3" stroke-width="0.5"/>
  <text x="50" y="295" fill="#8b8fa3" font-size="9" font-family="Inter,sans-serif">0</text>
  <text x="185" y="295" fill="#8b8fa3" font-size="9" font-family="Inter,sans-serif">6 parts</text>
  <text x="340" y="295" fill="#8b8fa3" font-size="9" font-family="Inter,sans-serif">900 kg</text>
</svg></div>`},
{n:10,title:"Calculs de TVA et devis",
...
<div class="key-point tip">💡 En BTS, tu devras constamment isoler des variables dans des formules de résistance des matériaux, thermique, etc.</div>
  ...
  exercises:[
{n:1,title:"Réduire une expression littérale",
statement:`Réduis :<ol>
<li>\\(3x+5x-2x\\)</li>
<li>\\(4a-7+2a+3\\)</li>
...
{n:2,title:"Développer (simple distributivité)",
...
{n:6,title:"Isoler une variable dans une formule",
...
{n:7,title:"Inéquations du 1er degré",
...
svg:`<div class="graph-container"><svg viewBox="0 0 500 350" xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    <pattern id="t2e7g" width="40" height="40" patternUnits="userSpaceOnUse">
      <line x1="40" y1="0" x2="40" y2="350" stroke="rgba(42,45,58,0.6)" stroke-width="0.5"/>
      <line x1="0" y1="40" x2="500" y2="40" stroke="rgba(42,45,58,0.6)" stroke-width="0.5"/>
    </pattern>
    <marker id="arrowRightT2e7" viewBox="0 0 10 10" refX="10" refY="5" markerWidth="6" markerHeight="6" orient="auto">
      <path d="M0,0 L10,5 L0,10" fill="none" stroke="#f97316" stroke-width="1.5"/>
    </marker>
    <marker id="arrowLeftT2e7" viewBox="0 0 10 10" refX="0" refY="5" markerWidth="6" markerHeight="6" orient="auto">
      <path d="M10,0 L0,5 L10,10" fill="none" stroke="#f97316" stroke-width="1.5"/>
    </marker>
  </defs>
  ...
  <line x1="100" y1="60" x2="100" y2="70" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="180" y1="60" x2="180" y2="70" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="260" y1="60" x2="260" y2="70" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="340" y1="60" x2="340" y2="70" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="380" y1="60" x2="380" y2="70" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="420" y1="60" x2="420" y2="70" stroke="#8b8fa3" stroke-width="1.5"/>
  ...
  <text x="258" y="55" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">0</text>
  <text x="338" y="55" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">2</text>
  <text x="378" y="55" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">3</text>
  <text x="418" y="55" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">4</text>
  <text x="10" y="69" fill="#10b981" font-size="10" font-family="Inter,sans-serif">x>3</text>
  <line x1="380" y1="65" x2="470" y2="65" stroke="#f97316" stroke-width="3.5" stroke-linecap="round"/>
  <circle cx="380" cy="65" r="5" fill="#1a1d27" stroke="#f97316" stroke-width="2.5"/>
  <line x1="460" y1="65" x2="470" y2="65" stroke="#f97316" stroke-width="3.5" marker-end="url(#arrowRightT2e7)"/>
  <line x1="40" y1="155" x2="460" y2="155" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="100" y1="150" x2="100" y2="160" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="180" y1="150" x2="180" y2="160" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="260" y1="150" x2="260" y2="160" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="340" y1="150" x2="340" y2="160" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="380" y1="150" x2="380" y2="160" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="420" y1="150" x2="420" y2="160" stroke="#8b8fa3" stroke-width="1.5"/>
  ...
  <text x="258" y="145" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">0</text>
  <text x="338" y="145" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">2</text>
  <text x="378" y="145" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">3</text>
  <text x="418" y="145" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">4</text>
  <text x="10" y="159" fill="#10b981" font-size="10" font-family="Inter,sans-serif">x>-2</text>
  <line x1="180" y1="155" x2="470" y2="155" stroke="#f97316" stroke-width="3.5" stroke-linecap="round"/>
  <circle cx="180" cy="155" r="5" fill="#f97316" stroke="#f97316" stroke-width="2.5"/>
  <line x1="460" y1="155" x2="470" y2="155" stroke="#f97316" stroke-width="3.5" marker-end="url(#arrowRightT2e7)"/>
  <line x1="40" y1="245" x2="460" y2="245" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="100" y1="240" x2="100" y2="250" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="180" y1="240" x2="180" y2="250" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="260" y1="240" x2="260" y2="250" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="340" y1="240" x2="340" y2="250" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="380" y1="240" x2="380" y2="250" stroke="#8b8fa3" stroke-width="1.5"/>
  <line x1="420" y1="240" x2="420" y2="250" stroke="#8b8fa3" stroke-width="1.5"/>
  ...
  <text x="258" y="235" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">0</text>
  <text x="338" y="235" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">2</text>
  <text x="378" y="235" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">3</text>
  <text x="418" y="235" fill="#8b8fa3" font-size="10" font-family="Inter,sans-serif">4</text>
  <text x="10" y="249" fill="#10b981" font-size="10" font-family="Inter,sans-serif">x<2</text>
  <line x1="30" y1="245" x2="340" y2="245" stroke="#f97316" stroke-width="3.5" stroke-linecap="round"/>
  <circle cx="340" cy="245" r="5" fill="#f97316" stroke="#f97316" stroke-width="2.5"/>
  <line x1="30" y1="245" x2="40" y2="245" stroke="#f97316" stroke-width="3.5" marker-end="url(#arrowLeftT2e7)"/>
...
{n:8,title:"Systèmes de 2 équations",
...
{n:9,title:"Identités remarquables",
...
{n:10,title:"Mise en équation (problème BTP)",
